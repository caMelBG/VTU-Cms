		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/mauris/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com' target='_blank'>SMThemes.com</a>, thanks to: <a href='http://theme.today/' target='_blank'>Theme.Today</a>, <a href='http://www.dpthemes.com/' target='_blank'>Free WordPress themes</a> and <a href='http://crocotheme.com/' target='_blank'>WordPress themes</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
	</div> <!-- / #footer -->
